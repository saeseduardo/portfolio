...
const translations = {
  es: {
    ...
    'about.p4':    'Resultados medibles en producción: <strong>35% menos latencia de API</strong>, 10.000+ requests concurrentes sin degradación, <strong>99,5% de uptime</strong> y automatización que eliminó 20+ horas semanales de trabajo manual. Experiencia remota con equipos internacionales en proyectos <strong>FinTech</strong>, plataformas empresariales y sistemas de alta disponibilidad.',
  ...
  en: {
    ...
    'about.p4':    'Measurable production results: <strong>35% lower API latency</strong>, 10,000+ concurrent requests without degradation, <strong>99.5% uptime</strong> and automation that eliminated 20+ hours of manual work per week. Remote experience with international teams on <strong>FinTech</strong> projects, enterprise platforms and high-availability systems.',
